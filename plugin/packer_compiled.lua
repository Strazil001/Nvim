...
_G.packer_plugins = {
  ...
  ["vim-razor"] = {
    loaded = true,
    path = "/home/sv/.local/share/nvim/site/pack/packer/start/vim-razor",
    url = "https://github.com/jlcrochet/vim-razor"
  },
  vimwiki = {
    loaded = true,
    path = "/home/sv/.local/share/nvim/site/pack/packer/start/vimwiki",
